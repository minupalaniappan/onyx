...
type EditTeamMemberSettingsOverlayProps = {
  open: boolean
  onClose: () => void
  user: User | undefined
}

const EditTeamMemberSettingsOverlay = (
  props: EditTeamMemberSettingsOverlayProps,
) => {
...
export default EditTeamMemberSettingsOverlay
