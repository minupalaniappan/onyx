...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        'flex flex-col gap-2 p-3 top-[1px] left-[2px] relative',
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      'peer-data-[size=default]/menu-button:top-1.5',
      'peer-data-[size=lg]/menu-button:top-2.5',
      'group-data-[collapsible=icon]:hidden !w-full',
      className,
    )}
    {...props}
  />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground !w-full',
        size === 'sm' && 'text-xs',
        size === 'md' && 'text-sm',
        'group-data-[collapsible=icon]:hidden',
        className,
